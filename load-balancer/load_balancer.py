...
class LoadBalancer(simple_switch_13.SimpleSwitch13):
    ...
    VIRTUAL_IP = '172.16.0.100'  # The virtual s3 - dmz 

    SERVER1_IP = '172.16.0.101' # HTTP SERVER 1
    SERVER1_MAC = '00:00:00:00:DD:01'
    SERVER1_PORT = 1 # HTTP SERVER PORT
    SERVER2_IP = '172.16.0.102' # HTTP SERVER 2
    SERVER2_MAC = '00:00:00:00:DD:02'
    SERVER2_PORT = 2 # HTTP SERVER PORT
